...
/**
 * Alpine PhotoTile for GooglePlus: WP_Widget
 *
 * @ Since 1.1.1
 * @ Updated 1.2.5
 */
 
class Alpine_PhotoTile_for_GooglePlus extends WP_Widget { 

	function Alpine_PhotoTile_for_GooglePlus() {
    $this->alpinebot = new PhotoTileForGooglePlusPrimary();
    $bot = $this->alpinebot;
